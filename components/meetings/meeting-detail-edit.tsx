...
export function MeetingDetailEdit({
  meetingId,
  editSessionKey,
  form,
  onFormChange,
      ...
      <form onSubmit={onSubmit}>
        <div className="grid gap-6 @[600px]:grid-cols-2">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              <div className="flex items-baseline gap-1">
                <p className={SECTION_LABEL_CLASSNAME}>
                  <Label htmlFor={`edit-rep-${meetingId}`}>
                    Member of Congress
                  </Label>
                </p>
                <span
            ...
            <div className="flex flex-col gap-2">
              <p className={SECTION_LABEL_CLASSNAME}>
                <Label htmlFor={`edit-team-${meetingId}`}>
                  Primary PIH Team
                </Label>
              </p>
              <TeamCombobox
            ...
            <div className="flex gap-4">
              <div className="flex min-w-0 flex-1 flex-col gap-2">
                <p className={SECTION_LABEL_CLASSNAME}>
                  <Label htmlFor={`edit-champion-${meetingId}`}>
                    Champion Score
                  </Label>
                </p>
                <Select
                  ...
                  onChange={(e) =>
                    onFormChange({ championScore: e.target.value })
                  }
                >
                  <option value="">—</option>
              ...
              <div className="flex min-w-0 flex-1 flex-col gap-2">
                <p className={SECTION_LABEL_CLASSNAME}>
                  <Label htmlFor={`edit-followup-${meetingId}`}>
                    Follow-up
                  </Label>
                </p>
                <Input
                  ...
                  onChange={(e) =>
                    onFormChange({ followUpDate: e.target.value })
                  }
                />
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <div className="flex min-w-0 flex-1 flex-col gap-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    onFormChange({ meetingDate: e.target.value })
                  }
                />
              </div>
              <div className="flex min-w-0 flex-1 flex-col gap-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    onFormChange({ meetingTime: e.target.value })
                  }
